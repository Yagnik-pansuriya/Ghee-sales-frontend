        ...
        <div className="relative overflow-hidden bg-primary text-white">
            ...
            <div className="absolute inset-0 z-0">
                ...
                <motion.div
                    ...
                    className="absolute top-1/4 -left-20 w-80 h-80 bg-secondary/10 rounded-full blur-[100px] will-change-[opacity]"
                />
                <motion.div
                    animate={{ opacity: [0.1, 0.2, 0.1] }}
                    transition={{ duration: 4, repeat: Infinity, ease: "easeInOut", delay: 2 }}
                    className="absolute bottom-1/4 -right-20 w-80 h-80 bg-secondary/10 rounded-full blur-[100px] will-change-[opacity]"
                />
            </div>
            ...
            <SectionWrapper className="relative z-10 py-24 md:py-32" bgColor="bg-transparent">
                <div className="max-w-5xl mx-auto">
                    ...
                    <motion.div
                        ...
                        className="text-center mb-16 md:mb-24 will-change-[transform,opacity]"
                    >
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 mb-24">
                        ...
                        <motion.div
                            ...
                            className="bg-white/5 backdrop-blur-md p-10 rounded-[40px] border border-white/10 hover:border-secondary/30 transition-colors group gpu-accelerated will-change-[transform,opacity]"
                        >
                            <div className="text-secondary text-5xl mb-6 transform group-hover:scale-110 transition-transform will-change-transform">
                                <GiCow />
                            </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                {benefits.map((benefit, i) => (
                                    <motion.div
                                        ...
                                        className="bg-white/5 p-4 rounded-2xl flex flex-col items-center text-center gap-3 border border-white/5 hover:bg-secondary/10 transition-colors will-change-[transform,opacity]"
                                    >
                        ...
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            transition={{ duration: 0.8 }}
                            className="bg-secondary p-8 md:p-12 rounded-[40px] md:rounded-[50px] text-primary relative overflow-hidden will-change-[transform,opacity]"
                        >
